...
public class StanzaMagicaProtected extends StanzaProtected {
	...
	public StanzaMagicaProtected(String nome, int soglia, int massimoAttrezzi, IO ioConsole) {
	...
	public StanzaMagicaProtected(String nome, int soglia, IO ioConsole) {
		this(nome, soglia, NUMERO_MASSIMO_ATTREZZI, ioConsole);
	}
	
	/*** Costruttore con soglia default e numero massimo attrezzi default*/
	public StanzaMagicaProtected(String nome, IO ioConsole) {
