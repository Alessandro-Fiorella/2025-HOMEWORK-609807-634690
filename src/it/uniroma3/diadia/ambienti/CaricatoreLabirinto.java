...
public class CaricatoreLabirinto {
	...
	// prefisso per le stanza magiche
	...
	private void leggiECreaStanzeMagiche() throws FormatoFileNonValidoException {
		...
		for (String specifica : separaStringheAlleVirgole(nomiStanze)) {
			try (Scanner sc = new Scanner(specifica.trim())) {
				String nome = sc.next();
				int soglia = sc.hasNextInt() ? sc.nextInt() : 1;
				Stanza magica = new StanzaMagica(nome, soglia);
				this.nome2stanza.put(nome, magica);
